...
export default function Create({ kelompoks, jenis_pohons, sortimens }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('admin.lhp.store'));
    };

    return (
        <AdminLayout>
            <Head title="SIPETAK Admin - Tambah LHP" />

            <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
                <div>
                    <h2 className="font-display text-display text-primary mb-2">Buat Laporan Hasil Produksi</h2>
                    <p className="font-body-md text-body-md text-on-surface-variant">Masukkan data Laporan Hasil Produksi (LHP) baru secara mandiri.</p>
                </div>
            </div>
                        ...
                        <div className="mb-6">
                            ...
                            <Select
                                ...
                                onChange={(val) => {
                                    ...
                                    setData('jenis_pohon_id', ''); // Reset jenis pohon when kelompok changes
                                }}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <TextInput
                                ...
                                placeholder="Contoh: LHP-001/2026"
                                required
                            />
