...
import { ArrowLeft, Save, ClipboardList, CheckCircle, Loader2 } from 'lucide-react';
...
export default function Edit({ pnbp, lhps }) {
    const { data, setData, put, processing, errors } = useForm({
        lhp_id: pnbp.lhp_id,
        kode_billing: pnbp.kode_billing,
        tanggal_kode_billing: pnbp.tanggal_kode_billing,
        jumlah: pnbp.jumlah,
        tanggal_bayar: pnbp.tanggal_bayar || '',
        ntpn: pnbp.ntpn || '',
    ...
    const lhpOptions = lhps.map(l => ({
        value: l.id,
        label: `${l.no_lhp} - ${l.kelompok?.nama_kelompok || 'Tidak ada kelompok'}`,
        psdh: l.psdh
    }));

    const handleSubmit = (e) => {
        e.preventDefault();
        put(route('admin.pnbp.update', pnbp.id));
    };

    const handleLhpChange = (selected) => {
        setData('lhp_id', selected ? selected.value : '');
    };
    ...
    return (
        <AdminLayout>
            <Head title="Edit Tagihan & Pembayaran PNBP - SIPETAK" />
            ...
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="font-body-md text-body-md text-on-surface-variant">Perbarui tagihan atau masukkan NTPN sebagai bukti pembayaran.</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 md:p-8">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="col-span-1 md:col-span-2">
                            <h3 className="text-lg font-bold text-primary mb-4 border-b border-outline-variant pb-2">Informasi Tagihan</h3>
                        </div>
                        ...
                        <div className="col-span-1 md:col-span-2">
                            ...
                            <Select
                                ...
                                isDisabled={true} // Usually you don't change LHP after billing is created, but it's passed just in case
                            />
                        ...
                        <div className="col-span-1 md:col-span-2 mt-4">
                            <h3 className="text-lg font-bold text-[#FB8500] mb-4 border-b border-outline-variant pb-2 flex items-center gap-2">
                    ...
                    <div className="mt-8 flex justify-end gap-3 pt-6 border-t border-outline-variant">
                        ...
                        <button
                            type="submit"
                            disabled={processing}
                            className="px-6 py-2.5 bg-[#FB8500] text-white rounded-lg font-bold hover:bg-opacity-90 transition-colors flex items-center gap-2 disabled:opacity-50"
                        >
