...
export default function Barcode() {
    ...
    const [isAddingBatang, setIsAddingBatang] = useState(false);
                    ...
                    <div className="grid grid-cols-12 gap-2 items-end">
                        ...
                        <div className="col-span-8">
                            <button 
                                ...
                                disabled={isAddingBatang || processing}
                                className={`w-full h-touch-target border-2 border-primary text-primary rounded font-label-caps text-label-caps flex items-center justify-center gap-2 transition-colors ${isAddingBatang || processing ? 'opacity-50 pointer-events-none' : 'active:bg-surface-container-high hover:bg-surface-container-low'}`}
                            >
                                {isAddingBatang || processing ? (
                                ...
                                {isAddingBatang ? 'Memproses...' : 'Tambah Batang'}
                            </button>
                        </div>
                    </div>
