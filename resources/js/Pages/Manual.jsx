                        ...
                        <form className="flex flex-col gap-6">
                            ...
                            <div className="pt-6 mt-4 border-t border-outline-variant flex justify-end">
                                <button 
                                    ...
                                    className={`h-touch-target px-8 bg-[#FB8500] text-white font-headline-md text-headline-md-mobile rounded-DEFAULT transition-all w-full md:w-auto shadow-sm flex items-center justify-center gap-2 ${isAddingBatang || processing ? 'opacity-50 pointer-events-none' : 'hover:bg-[#e67a00] active:scale-95'}`}
                                >
