...
<head>
    ...
    <title>Verifikasi Dokumen Angkutan</title>
...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-4">
    <div class="bg-white rounded-xl shadow-lg max-w-md w-full overflow-hidden">
        <div class="bg-green-600 text-white text-center py-6 px-4">
            ...
            <p class="text-green-100 mt-1">Dokumen Angkutan Kayu</p>
        </div>
        ...
        <div class="p-6">
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-lg text-gray-900 font-semibold">{{ $dokumen->no_dokumen }}</p>
                </div>
                
                <div class="border-t border-gray-100 pt-4">
                    <p class="text-sm text-gray-500 font-medium">Tanggal Dibuat</p>
                    <p class="text-gray-900">{{ $dokumen->created_at->translatedFormat('d F Y H:i') }} WIB</p>
                </div>

                <div class="border-t border-gray-100 pt-4">
                    <p class="text-sm text-gray-500 font-medium">Penerbit</p>
                    <p class="text-gray-900">{{ $dokumen->penerbit->nama ?? 'Ganis PKB' }}</p>
                </div>
            </div>
